				...
				<div class="tab-content">
					<div class="container custom tab-pane active px-0" style="background-color: white; ">
						<div class="row">
							...
							<div class="col-md-12">
  <form method="post" id="quiz_detail" action="<?php echo site_url('Questions/post_validate_quiz/'.$quiz['quid']);?>">
...
?>	
 ...
 <?php 
	...
	<button class="btn btn-success" type="submit"><?php echo $this->lang->line('start_quiz');?></button>
 &nbsp;&nbsp;&nbsp;&nbsp; <a href="<?php echo site_url('Questions/open_quiz/0');?>" ><?php echo $this->lang->line('back');?></a>
