  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content">
		<div class="box box-default">
		 ...
		 <form method="post" action="<?php echo site_url('admin/post-insert_level/');?>">
...
<a href="<?php echo site_url('admin/pre_remove_level/'.$val['lid']);?>"><img src="<?php echo base_url('images/cross.png');?>"></a>
