...
<form method="post" action="<?php echo site_url('admin/update_quiz/'.$quiz['quid']);?>">
			...
			?>
				...
				<div class="form-group">	 
					<label   ><?php echo $this->lang->line('assign_to_group');?></label> <br>
						 <input type="checkbox" name="gids[]" value="1" checked=""> Free &nbsp;&nbsp;&nbsp;
...
?>
 ...
 ?>
 <a href="<?php echo site_url('admin/add_question/'.$quiz['quid']);?>" class="btn btn-danger"  ><?php echo $this->lang->line('add_question_into_quiz');?></a>
<?php
 }else{
