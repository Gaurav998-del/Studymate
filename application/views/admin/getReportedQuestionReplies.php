...
?>
	...
	<div id="questionModel" class="modal fade" role="dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Question Reply Description</h4>
			</div>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
		<h1>
        Website reported question's reply
        <small>Update</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="active">Question's Reply</li>
		</ol>
    </section>
				...
				<div class="col-md-12">
					<div class="table-responsive">
						<table class="table table-bordered table-hover table-responsive">
							...
							<tbody>
							<?php 
							if (count($getReportedQuestionReplies)>0) {
								foreach ($getReportedQuestionReplies as $index=>$value) {?>
								<tr id="<?php echo "question-".$value['reportRId'];?>">
									...
									<td>
										<button data-reportRId="<?php echo $value['reportRId'];?>" type="button" class="btn deleteReply btn-danger">Delete question Reply</button>
									</td>
								</tr>
							<?php } 
							} else {?>
			...
			buttons: {
				deleteReply: {
					...
					action: function () {
						...
						$.ajax({
							type:'POST',
							url:'<?php echo base_url()."post-admin-delete-question-reply";?>',
							type: "POST",
							data : fd,
							processData: false,
							contentType: false,
