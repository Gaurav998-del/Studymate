		...
		<div class="upper-search"> 
			<div class="container custom">
				<div class="row justify-content-sm-center">
					...
					<?php echo form_open_multipart('searchquestion', array('id' => 'form-login', 'class' => 'form-horizontal'));?>
					
						<div class="inner-search row">
							<input type="text" id="search" class="col-9 col-sm-10 col-md-11  main-search" placeholder="Search" name="search">
								<!--<div id="loaderSearch" class="d-none loader-main-input">
									<!-- Loader 5 -->
									<!--<div class=" loader-5 center"><span></span></div>
								</div>--><input id="searchBtn" type="submit" class="col-3 col-sm-2 col-md-1  btn btn-search-upper"  value="search" style="
					...
					<div class="inner-question main">
						...
						<?php if (count($getAllQuestions)>0) {?>
							<div class="text-center">
								<a class="btn btn-viewall-index w-100" href="<?php echo base_url()."questions";?>">View All</a>
							</div>
						<?php } else {?>
